...
public class ExhibitorInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Exhibition Year");

        jLabel4.setText("Booth Number");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/exhibitor/gui/user.png"))); // NOI18N
        ...
        jButton3.setText("CLICK HERE FOR DETAILS");
        ...
        jTabbedPane1.addTab("Accounting Info", jPanel5);

        jButton5.setText("CLICK HERE FOR DETAILS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExhibitorInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExhibitorInfo().setVisible(true);
            }
        });
    }
